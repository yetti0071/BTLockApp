...
/*  // Unique UUID for this application
    private static final UUID MY_UUID_SECURE =
        UUID.fromString("fb87c0d0-bfac-11d1-8259-0800200c9a66");
    private static final UUID MY_UUID_INSECURE =
        UUID.fromString("8be255b0-2005-1510-ab64-0800200c9a66");
*/
...
*/
    ...
    public void write(byte[] out) {
        ...
        synchronized (this) {
            if (mState != STATE_CONNECTED) {
                    Log.w(BluetoothChatService.TAG, "connection is not confirmed yet");
                return;}
            r = mConnectedThread;
        }
    ...
    private class ConnectThread {
        ...
        public void run() {
            ...
            mAdapter.cancelDiscovery();  //TODO this does not need to be here I guess
